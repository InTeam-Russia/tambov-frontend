...
<section class="main-section">
    <Card>
        <CardHeader>
          ...
          <CardDescription>Чтобы получить информацию об организации, введите её ИНН в поле ниже:</CardDescription>
        </CardHeader>
        <CardContent>
            {#if error}
                <Alert.Root variant="destructive" class="mb-8 transition-all">
        ...
        <CardFooter class="flex justify-end">
            <Button class="flex flex-row items-center"  on:click={loadOrganisation}><Search class="mr-2 h-4 w-4" />&nbsp;Найти</Button>
        </CardFooter>
      </Card>
